...
const Prediction = Variant({ "Fake": Null, "Real": Null });
...
Service({
  ...
  "deleteReview": Func([Nat], [Bool], []),
  "getAnalytics": Func([], [AnalyticsSummary], ["query"]),
  "getCallerUserProfile": Func(
    [],
    [Opt(Record({ "username": Text, "name": Text }))],
    ["query"]
  ),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getReviewHistory": Func(
  ...
  "saveCallerUserProfile": Func(
    [Record({ "username": Text, "name": Text })],
    [],
    []
  ),
  "submitContact": Func([ContactInput], [Bool], []),
  "submitReview": Func([Text], [ReviewResult], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Prediction2 = IDL2.Variant({ "Fake": IDL2.Null, "Real": IDL2.Null });
  const ClassificationResult2 = IDL2.Record({
    "prediction": Prediction2,
    "reviewText": IDL2.Text,
    "confidence": IDL2.Nat,
    "suspiciousWords": IDL2.Vec(IDL2.Text)
  });
  const DailyBreakdown2 = IDL2.Record({
    "date": IDL2.Text,
    "realCount": IDL2.Nat,
    "fakeCount": IDL2.Nat
  });
  const AnalyticsSummary2 = IDL2.Record({
    "realCount": IDL2.Nat,
    "fakeCount": IDL2.Nat,
    "dailyBreakdown": IDL2.Vec(DailyBreakdown2),
    "totalReviews": IDL2.Nat
  });
  const ReviewFilter2 = IDL2.Variant({
    "All": IDL2.Null,
    "Fake": IDL2.Null,
    "Real": IDL2.Null
  });
  ...
  const ReviewResult2 = IDL2.Record({
    "id": ReviewId2,
    "prediction": Prediction2,
    "reviewText": IDL2.Text,
  ...
  const ReviewPage2 = IDL2.Record({
    "page": IDL2.Nat,
    "pageSize": IDL2.Nat,
    "items": IDL2.Vec(ReviewResult2),
    "totalPages": IDL2.Nat,
    "totalItems": IDL2.Nat
  });
  ...
  return IDL2.Service({
    ...
    "bulkClassify": IDL2.Func(
      [IDL2.Vec(IDL2.Text)],
      [IDL2.Vec(ClassificationResult2)],
      []
    ),
    "deleteReview": IDL2.Func([IDL2.Nat], [IDL2.Bool], []),
    "getAnalytics": IDL2.Func([], [AnalyticsSummary2], ["query"]),
    "getCallerUserProfile": IDL2.Func(
      [],
      [IDL2.Opt(IDL2.Record({ "username": IDL2.Text, "name": IDL2.Text }))],
      ["query"]
    ),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getReviewHistory": IDL2.Func(
      [ReviewFilter2, PaginationParams2],
      [ReviewPage2],
      ["query"]
    ),
    ...
    "saveCallerUserProfile": IDL2.Func(
      [IDL2.Record({ "username": IDL2.Text, "name": IDL2.Text })],
      [],
      []
    ),
    "submitContact": IDL2.Func([ContactInput2], [IDL2.Bool], []),
    "submitReview": IDL2.Func([IDL2.Text], [ReviewResult2], [])
  });
};
class Backend {
  ...
  async getReviewHistory(arg0, arg1) {
    if (this.processError) {
      try {
...
function from_candid_ClassificationResult_n4(_uploadFile, _downloadFile, value) {
  return from_candid_record_n5(_uploadFile, _downloadFile, value);
}
function from_candid_Prediction_n6(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n7(_uploadFile, _downloadFile, value);
}
function from_candid_ReviewPage_n13(_uploadFile, _downloadFile, value) {
  return from_candid_record_n14(_uploadFile, _downloadFile, value);
}
function from_candid_ReviewResult_n16(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n7(_uploadFile, _downloadFile, value) {
  return "Fake" in value ? "Fake" : "Real" in value ? "Real" : value;
}
...
function to_candid_ReviewFilter_n11(_uploadFile, _downloadFile, value) {
...
function addReview(result) {
  ...
  saveReviews(reviews.slice(0, 500));
}
function useSubmitReview() {
  ...
  return useMutation({
    mutationFn: async (reviewText) => {
      if (actor) {
        try {
          const result2 = await actor.submitReview(reviewText);
          return result2;
        } catch {
        }
      }
      const { verdict, confidence, suspiciousWords } = classifyReview(reviewText);
      const result = {
        id: ++localIdCounter,
        reviewText,
        verdict,
...
function useBulkClassify() {
  ...
  return useMutation({
    mutationFn: async (texts) => {
      if (actor) {
        try {
          const results2 = await actor.bulkClassify(texts);
          return results2;
        } catch {
        }
      }
...
function useReviewHistory(filter, pagination) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (actor) {
        try {
          return await actor.getReviewHistory(filter, pagination);
        } catch {
        }
      }
...
function useDeleteReview() {
  ...
  return useMutation({
    mutationFn: async (id) => {
      if (actor) {
        try {
          return await actor.deleteReview(id);
        } catch {
        }
      }
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      for (const r of reviews) {
        const dateStr = new Date(Number(r.timestamp)).toISOString().slice(0, 10);
      ...
      const topSuspiciousWords = Object.entries(wordMap).sort((a, b) => b[1] - a[1]).slice(0, 10).map(([word, count]) => ({ word, count }));
...
function useSubmitContact() {
  ...
  return useMutation({
    mutationFn: async (input) => {
      if (actor) {
        try {
          return await actor.submitContact(input);
        } catch {
        }
      }
...
export {
  useAnalytics as a,
  useReviewHistory as b,
  useSubmitReview as c,
  useBulkClassify as d,
  useDeleteReview as e,
  useSubmitContact as u
};
